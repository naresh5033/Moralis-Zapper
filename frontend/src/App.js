...
function App() {
  ...
  const [filteredNfts, setFilteredNfts] = useState([]); //for filtering the nfts that match our search condn, and pass it as prop for nft comp
  const [transfers, setTransfers] = useState([]);// for the erc20 tkn transfer/ trasnferHistory
        ...
        <div className="walletInfo">
          {wallet.length === 42 && (
            <>
              ...
              {/* put all our comp inside web3uikit's tablist */}
        <TabList>
